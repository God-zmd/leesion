...
<script type="text/javascript">
    var grid_data =[
        <c:forEach items="${grades}" var="s">
            {name:"${s.name}",number:"${s.number}",average:"${s.average}"},
        </c:forEach>
    ];
        /*[
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel:[
                ...
                {name:'average',index:'average', width:70, sortable:true,editable: true,edittype:"select", editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
            ],
